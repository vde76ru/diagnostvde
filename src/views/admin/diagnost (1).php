 ...
 * 
 * 1. В файл public/index.php добавить роут (после других админских роутов):
 *    $router->get('/admin/diagnost', function() {
 *        \App\Middleware\AuthMiddleware::requireRole('admin');
 *        \App\Core\Layout::render('admin/diagnost', []);
 *    });
 * 
 * 2. В файл src/views/admin/index.php добавить ссылку:
 *    <li><a href="/admin/diagnost">🔍 Диагностика системы</a></li>
 * 
 * 3. В сайдбар (public/header.php) в секцию "Управление" добавить:
 *    <li class="nav-item">
 *        <a href="/admin/diagnost" class="nav-link">
 *            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 *                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
 *                      d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
 *                </path>
 *            </svg>
 *            <span class="nav-text">Диагностика</span>
 *        </a>
 *    </li>
 */
